...
const data = [
  {
    head:"Your Mental health is Important", 
    sub:"Chakras are energy centers in the body that are believed to affect physical, emotional, and mental health. There are seven main chakras, each corresponding to a different part of the body and representing different aspects of our being", 
    btn:"Get Started", 
    link:"/stable",
    ele: <AboutIcon />
  },
  ...
  {
    head:"About Us", 
    sub:"STABLE is a self meditation web application which will help the user to keep themselves mentally fit during the hard times of their life, an will help them to take the right decision.", 
    btn:"About", 
    link:"/about",
    ele: <HomeYoga/>
  },
